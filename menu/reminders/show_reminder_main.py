...
async def show_reminder_main(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # --- Boutons alignés ---
    labels = [
        t("reminder_main_create", lang),
        t("reminder_main_edit", lang),
        t("reminder_main_delete", lang),
    ]
    ...
    clavier = InlineKeyboardMarkup([
        [InlineKeyboardButton(padded[0], callback_data="reminder:new")],
        [InlineKeyboardButton(padded[1], callback_data="reminder:edit_list")],
        [InlineKeyboardButton(padded[2], callback_data="reminder:delete_list")],
