...
async def show_welcome_config(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Affiche la configuration du message de bienvenue."""
    ...
    # Message de succès temporaire (après modification)
    success_msg = ""
...
async def show_welcome_edit_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Ici on doit garder edit_message_text car on veut remplacer le contenu
    # sans supprimer l'ancien message (pas de display_message qui supprimerait l'ancien)
